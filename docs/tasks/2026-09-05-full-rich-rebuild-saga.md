...
Status: operational recovery implemented by `run_full_rich_baseline_v3.py` on
2026-09-08.  The earlier `run_full_rich_rebuild_v2.py` coordinator remains a
fail-closed protocol scaffold and is not the production mutation entrypoint.
Live cutover remains `BLOCKED` until the 2026-09-08 security gate, package
parity, live inventory, full baseline, compatibility readback, and incremental
catch-up all pass.
